		...
		<section className="w-full px-6 sm:px-12 py-8" style={{ backgroundColor: "#FFFFFF" }}>
			<div className="mx-auto max-w-7xl">
				...
				<div className="flex items-center gap-3 mb-4">
					<h2 className="text-4xl sm:text-5xl font-bold text-black">Why Z Treats</h2>
				...
				<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
					...
					<div className="flex flex-col gap-6">
						...
						<div className="rounded-3xl p-5 flex flex-col justify-center min-h-28 lg:min-h-32" style={{ backgroundColor: cards[0].bgColorValue }}>
							<h3 className="text-2xl font-bold mb-2" style={{ color: cards[0].textColor }}>
								{cards[0].title}
							</h3>
							<p className="text-sm" style={{ color: cards[0].textColor }}>
								{cards[0].description}
							</p>
						</div>
					...
					<div className="flex flex-col gap-6 h-full">
						...
						<div className="rounded-3xl p-5 flex flex-col justify-center flex-1" style={{ backgroundColor: cards[1].bgColorValue }}>
							<h3 className="text-2xl font-bold mb-2" style={{ color: cards[1].textColor }}>
								{cards[1].title}
							</h3>
							<p className="text-sm" style={{ color: cards[1].textColor }}>
								{cards[1].description}
							</p>
						</div>

						{/* Card 5 - Smartly Healthy */}
						<div className="rounded-3xl p-5 flex flex-col justify-center flex-1" style={{ backgroundColor: cards[4].bgColorValue }}>
							<h3 className="text-2xl font-bold mb-2" style={{ color: cards[4].textColor }}>
								{cards[4].title}
							</h3>
							<p className="text-sm" style={{ color: cards[4].textColor }}>
								{cards[4].description}
							</p>
						</div>

						{/* Card 7 - Always Fresh */}
						<div className="rounded-3xl p-5 flex flex-col justify-center flex-1" style={{ backgroundColor: cards[6].bgColorValue }}>
							<h3 className="text-2xl font-bold mb-2" style={{ color: cards[6].textColor }}>
								{cards[6].title}
							</h3>
							<p className="text-sm" style={{ color: cards[6].textColor }}>
								{cards[6].description}
							</p>
						</div>
					</div>
					...
					<div className="flex flex-col gap-6">
						...
						<div className="rounded-3xl p-5 flex flex-col justify-center min-h-28 lg:min-h-32" style={{ backgroundColor: cards[7].bgColorValue }}>
							<h3 className="text-2xl font-bold mb-2" style={{ color: cards[7].textColor }}>
								{cards[7].title}
							</h3>
							<p className="text-sm" style={{ color: cards[7].textColor }}>
								{cards[7].description}
							</p>
						</div>
					</div>
