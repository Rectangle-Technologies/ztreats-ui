			...
			<div className="mx-auto">
				<div className="grid grid-cols-1 gap-10">
					...
					<div className="relative w-screen">
						<h2 className="text-3xl md:text-4xl px-8 md:px-10 font-bold mb-4 font-[amaranth]">Our Vision</h2>
					...
					<div className="relative w-screen flex flex-col lg:items-end">
						<h2 className="lg:w-1/2 text-3xl md:text-4xl font-bold px-8 md:px-10 mb-4 text-[#1a1a1a] font-[amaranth]">Our Mission</h2>

						<div className="bg-[#FFD46C] pl-8 py-8 md:p-10 lg:w-1/2">
							<p className="text-base leading-relaxed text-[#1a1a1a] mb-4">At ZTreats, our mission is to deliver thoughtfully curated dry fruits, nuts, and gourmet hampers that blend purity with sophistication.</p>
