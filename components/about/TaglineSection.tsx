...
export default function TaglineSection() {
	return (
		<section className="w-full bg-[#055066] py-6 md:py-10 relative overflow-hidden font-[amaranth]">
			{/* Background Pattern */}
			...
			{/* Content */}
			<div className="mx-auto max-w-7xl px-8 sm:px-12 relative z-10">
				<div className="flex flex-col items-center justify-center text-center">
					<h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-[#7AC9B3] mb-12 leading-tight">
						Snack Smarter. Snack Healthier.
						<br className="lg:hidden"/> {" "}
						With ZTreats.
					</h2>

					<PaddedButton className="bg-white text-[#055066] hover:bg-gray-100">Chat with Us</PaddedButton>
				</div>
			</div>
		</section>
	);
