		...
		<section className="w-full bg-[#FFD46C] relative overflow-hidden">
			<div className="mx-auto h-[70vh] max-w-7xl px-6 sm:px-12 py-4">
				<div className="flex items-center h-full w-full relative">
					...
					<PaddedButton size="sm" className="border-2 border-[#055066] bg-transparent text-[#055066] hover:bg-[#055066] hover:text-white lg:hidden p-5w text-xs" onClick={() => router.push('/products')}>
						View Products
					</PaddedButton>
					<PaddedButton size="lg" className="border-2 border-[#055066] bg-transparent text-[#055066] hover:bg-[#055066] hover:text-white hidden lg:flex p-7 text-base" onClick={() => router.push('/products')}>
						View Products
					</PaddedButton>
				</div>
