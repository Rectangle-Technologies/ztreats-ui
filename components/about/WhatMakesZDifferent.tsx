	...
	return (
		<section className="w-full bg-white py-16 md:py-16">
			<div className="mx-auto max-w-7xl px-6 sm:px-12">
				<h2 className="text-3xl md:text-5xl font-bold mb-10 font-[amaranth]">What Makes Z Treats Different</h2>

				<div className="grid grid-cols-1 md:grid-cols-3 gap-6 font-normal">
					{/* Our Belief Card */}
					<div className="bg-[#FF6B5B] rounded-3xl p-6 text-white">
						<div className="mb-3">
					...
					{/* Our Approach Card */}
					<div className="bg-[#FFD46C] rounded-3xl p-6 text-[#333]">
						<div className="mb-3">
							<PenToolIcon className="-rotate-90" />
						</div>
					...
					{/* Our Purpose Card */}
					<div className="bg-[#7CB342] rounded-3xl p-6 text-white">
						<div className="mb-3">
							<PenToolIcon className="-rotate-90" />
						</div>
